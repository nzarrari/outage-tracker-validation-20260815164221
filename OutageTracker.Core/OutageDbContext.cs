...
public class OutageDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Outage>().HasData(
            new Outage { Id = Guid.Parse("11111111-1111-1111-1111-111111111111"), Region = "East-01",  Description = "Transformer fire on Elm St", ReportedAt = new DateTime(2026, 8, 14, 20, 15, 0), EstimatedRestorationAt = new DateTime(2026, 8, 14, 22, 0, 0), Severity = 1 },
